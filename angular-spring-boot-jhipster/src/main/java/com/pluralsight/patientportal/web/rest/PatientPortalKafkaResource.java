...
@RestController
@RequestMapping("/api/patient-portal-kafka")
public class PatientPortalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PatientPortalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PatientPortalKafkaResource(KafkaProperties kafkaProperties) {
